...
/**
 * Main class of an “Adventure game”, that takes the user’s input to travel through many locations.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /**
         * This map allows user to write the chosen directions in different ways.
         */
